...
<body>
  ...
  <aside  class="sidebar " style="background-color:grey">
    ...
    <li class="nav-item">
        <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary mt-2" type="button">
        ...
        <!--
            ...
            <li class="nav-item">
                <div class="dropdown">
                    <a href="" class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-users"></i> Lister utilisateurs
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      <li><a class="dropdown-item" href="{{ route('admin.medecin.listerMedecin') }}">Lister Médecins</a></li>
                    </ul>
                  </div>
                <!--
                <a class="nav-link " href="">
          ...
          <hr class="sidebar- text-light">
            ...
            <li class="nav-item">
                <div class="dropdown">
                    <a href="" class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-users"></i> Ajouter Utilisateurs
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      <li><a class="dropdown-item" href="{{ route('admin.medecin.ajouterMedecin') }}">Ajouter Médecins</a></li>
                      <li><a class="dropdown-item" href="{{ route('ajouterSec') }}">Ajouter Secretaires</a></li>
                    </ul>
                  </div>
                <!--
                <a class="nav-link " href="">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.statistique') }}" class="btn btn-secondary mt-2" type="button">
                    <i class="fas fa-file"></i> Statistiques
                </a>
                <!--
                <a class="nav-link" href="">
