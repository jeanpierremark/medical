                            ...
                            <div id="c3" style="border-left:5px solid darkblue;" class="card  bg-white shadow h-60 py-2">
                                <div class="card-body ">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <a style="color: darkblue;text-decoration: none;font-weight: bold;" class="h3  mb-0 font-weight-bold" href="">Ouvrir  Dossier</a>
                                           
                                        </div>
                                        <div class="col-auto">
                                            <a href=""><i class="fas fa-folder  fa-3x " style=" color: darkblue;"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
