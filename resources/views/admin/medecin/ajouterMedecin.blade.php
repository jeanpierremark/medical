...
@section('content')
    <form method="POST" action="{{ route('ajouterMedecin') }}">
        @csrf
        <div class="card">
            <div class="card-header text-center fw-bold text-black fs-4 bg-primary">Ajouter Medecin</div>
            <div class="card-body">
                            ...
                            <div class="row mb-4 mt-2">
                                <div class="input-group col-sm">
                                    ...
                                    <input type="text" name="role" class="form-control border border-dark"
                                        id="inputEmail3" placeholder="role" value="medecin">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                ...
                <div class="container">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="btn btn-danger" style="margin-left: 60%">retour</a>
                </div>
            </div>
        </div>
    </form>
