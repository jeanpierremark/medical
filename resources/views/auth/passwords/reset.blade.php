...
<form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-primary text-md-end"><span class="fa fa-user fa-2x"></span></label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-primary text-md-end"><span class="fa fa-lock fa-2x"></span></label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-primary text-md-end"><span class="fa fa-lock fa-2x"></span></label>
