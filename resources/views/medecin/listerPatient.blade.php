...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header justify-content-between" style="border-top:2px solid #37c7cd">
                        ...
                        <tbody>
                            @foreach ($patients as $patient)
                                <tr>
                                    ...
                                    <td>{{$patient->age}}</td>
                                    <td>
                                        <a href="" class="btn" style="background-color:#39a709"><span class="bi bi-eye text-light"></span></a>
