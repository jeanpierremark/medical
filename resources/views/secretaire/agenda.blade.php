                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div style="border-left:5px solid darkblue;" class="card bg-light  shadow h-60 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center justify-content-between">
                                        <div class="col mr-2">
                                            <a style="color: darkblue;text-decoration: none;font-weight: bold;" class="h3  mb-0 font-weight-bold " href="{{route('getevent')}}">Agenda</a>
                                            
                                        </div>
                                        <div class="col-auto">
                                            <a href="{{route('getevent')}}"><i class="fas fa-calendar-alt fa-3x" style=" color: darkblue;"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
