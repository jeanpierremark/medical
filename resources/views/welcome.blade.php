...
<html lang="en">
  ...
  <!-- Template Main CSS File -->
    ...
    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end"> <span class="fa fa-lock  fa-2x text-primary"></span></label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    &nbsp; &nbsp; &nbsp;<a class=" text-primary" style="font-size: 20px; font-weight:bold" href="{{ route('password.request') }}">
                                      Mot de passe oublié?
                                    </a>
                                @endif
                            </div>
